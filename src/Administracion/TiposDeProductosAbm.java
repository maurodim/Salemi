 ...
 * @author mauro
 */
public class TiposDeProductosAbm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Alta - Baja y Modificaciones de Tipos de Servicios");

        jLabel1.setText("Seleccione  el Tipo de Serv.");
